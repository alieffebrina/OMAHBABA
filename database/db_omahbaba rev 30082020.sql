...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2020 at 10:00 AM
...
INSERT INTO `tb_barang` (`id_barang`, `barang`, `barcode`, `expaid`, `id_gudang`, `id_cabang`, `id_satuan`, `id_kategori`, `id_warna`, `ukuran`, `merk`, `hargabeli`, `id_user`, `tglupdate`, `id_konversi`, `hasil_konversi`) VALUES
(2, 'Sabun wings', 1000, '2020-08-29', 1, 1, 1, 4, 2, '212', 'winsfood', 3000000, 1, '2020-08-29', 0, 0),
(3, 'Sabun Colek', 2000, '2020-08-29', 3, 2, 19, 5, 6, '21', 'Wings Surya', 100000, 1, '2020-08-29', 0, 0),
(4, 'Sabun Cuci Piring', 20201, '2020-08-29', 3, 2, 20, 5, 1, '500', 'Wings Biru', 6800, 1, '2020-08-29', 0, 0);
...
(1, 'mebel', 1, '2020-08-24'),
(4, 'Furnitures', 1, '2020-08-29'),
...
(1, 'biru', 1, '2020-08-24'),
(2, 'merah', 1, '2020-08-24'),
(3, 'kuning', 1, '2020-08-29'),
(5, 'hijau', 1, '2020-08-29'),
(6, 'hijau tosca', 1, '2020-08-29');
...
--
ALTER TABLE `tb_submenu`
  MODIFY `id_submenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;
--
