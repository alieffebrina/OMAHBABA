...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2020 pada 22.36
...
INSERT INTO `tb_barang` (`id_barang`, `fotobarang`, `barang`, `barcode`, `expaid`, `id_gudang`, `id_cabang`, `id_satuan`, `id_kategori`, `id_warna`, `ukuran`, `merk`, `stok`, `stokmin`, `stokretur`, `hargabeli`, `id_user`, `tglupdate`) VALUES
(8, 'administrator.jpg', 'Sabun Coleksssssss', 20201, '2020-09-25', 3, 1, 23, 5, 2, '26', 'Wings Suryanjayani', 1985, 10, 3, 3000000, 1, '2020-09-25'),
(9, '4x6 red.jpg', 'Sabun Colek', 20120, '2020-09-25', 3, 1, 21, 5, 1, '500', 'Wings Surya', 8, 10, 0, 2000000, 1, '2020-09-25'),
(10, 'administrator.jpg', 'Sabun Colek', 1000, '2020-09-25', 3, 2, 23, 5, 1, '26', 'Wings Surya', 197, 6, 0, 5000000, 1, '2020-09-25'),
(12, '4x6 red.jpg', 'Sabun Baby', 2010, '2020-09-26', 3, 2, 23, 6, 2, '500', 'winsfood', 200, 6, 0, 3000000, 1, '2020-09-25'),
(14, 'administrator.jpg', 'Sabun Colek', 20201, '2020-09-25', 3, 2, 21, 5, 1, '26', 'Wings Surya', 10, 1, 0, 5000, 1, '2020-09-25'),
(15, '4x6 red.jpg', 'Sabun Cair', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 9, 1, 0, 100000, 1, '2020-09-30'),
(16, 'administrator.jpg', 'Barang Seken', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 8, 1, 0, 100000, 1, '2020-09-30'),
(17, 'administrator.jpg', 'Barang baru', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 10, 1, 0, 100000, 1, '2020-09-30'),
(18, '4x6 red.jpg', 'Wings Colek', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 8, 1, 0, 100000, 1, '2020-09-30'),
(19, '4x6 red.jpg', 'Sabun Mandi', 20120, '2020-09-25', 3, 2, 21, 5, 1, '500', 'Wings Surya', 2, 10, 2, 2000000, 1, '2020-09-25'),
(20, '4x6 red.jpg', 'Sabun Pria', 20120, '2020-09-25', 3, 2, 21, 5, 1, '500', 'Wings Surya', 10, 10, 0, 2000000, 1, '2020-09-25'),
(21, 'administrator.jpg', 'Sabun Jompo', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 10, 1, 0, 100000, 1, '2020-09-30'),
(22, 'administrator.jpg', 'Sabun Zen', 20201, '2020-09-30', 3, 2, 21, 5, 1, '21', 'Wings Surya', 10, 1, 0, 100000, 1, '2020-09-30'),
(23, '4x6 red.jpg', 'Sabun Cuci Piring', 5050, '2020-10-15', 3, 2, 23, 6, 1, '21', 'Wings Surya', 2000, 100, 0, 200000, 1, '2020-10-14');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_baranggaram`
--
...
--
-- Dumping data untuk tabel `tb_baranggaram`
--
...
--
-- Struktur dari tabel `tb_bonussales`
--

CREATE TABLE `tb_bonussales` (
  `id_bonussales` int(11) NOT NULL,
  `id_sales` int(11) NOT NULL,
  `tglbonus` date NOT NULL,
...
INSERT INTO `tb_cabang` (`id_cabang`, `namacabang`, `id_kota`, `id_kecamatan`, `id_provinsi`, `alamat`, `tlf`, `email`, `user`, `tglupdate`) VALUES
(1, 'cabang brebess', '5107', '5107040', '51', 'bali', '1232112', 'asd@asd', 1, '2020-10-21'),
(2, 'cabang b ', '5101', '5101030', '51', 'sad', '13123123', 'asda@asd', 1, '2020-08-22'),
(3, 'rumah mifta', '1107', '1107050', '11', '', '12314124', 'hijriyahque@yahoo.com', 1, '2020-10-21'),
(4, 'rumah ku', '1107', '1107062', '11', '', '124124', 'hijriyahque@yahoo.com', 1, '2020-10-21'),
(5, 'cabang 1', '1112', '1112030', '11', '', '12314', 'hijriyahque@yahoo.com', 1, '2020-10-21'),
(6, 'jombang', '3604', '3604050', '36', '', '081330181664', 'hijriyahque@ymail.com', 1, '2020-10-21');
...
--
-- Dumping data untuk tabel `tb_dtljual`
--

INSERT INTO `tb_dtljual` (`id_detailpenjualan`, `id_penjualan`, `id_barang`, `satuan`, `harga`, `qtt`, `diskon`, `subtotal`) VALUES
(1, 'admin-PO-05-10-2020-1', 8, 21, 3000000.00, 2, 0.00, 6000000.00),
(5, 'administrator-PO-05-10-2020-3', 19, 0, 2000000.00, 4, 0.00, 8000000.00),
(6, 'administrator-PO-05-10-2020-4', 16, 0, 100000.00, 1, 0.00, 100000.00),
(7, 'administrator-PO-05-10-2020-4', 15, 0, 100000.00, 1, 0.00, 100000.00),
(8, 'administrator-PO-05-10-2020-4', 19, 0, 2000000.00, 1, 0.00, 2000000.00),
(9, 'administrator-PO-07-10-2020-6', 18, 0, 100000.00, 1, 0.00, 100000.00),
(10, 'administrator-PO-07-10-2020-6', 19, 0, 2000000.00, 1, 0.00, 2000000.00),
(11, 'administrator-PO-07-10-2020-7', 10, 0, 5000000.00, 1, 0.00, 5000000.00),
(12, 'administrator-PO-07-10-2020-7', 16, 0, 100000.00, 1, 0.00, 100000.00),
(13, 'administrator-PO-07-10-2020-8', 8, 0, 3000000.00, 1, 0.00, 3000000.00),
(14, 'administrator-PO-07-10-2020-8', 9, 0, 2000000.00, 1, 0.00, 2000000.00),
(15, 'administrator-PO-07-10-2020-8', 10, 0, 5000000.00, 2, 0.00, 10000000.00),
(16, 'admin-PO-07-10-2020-9', 8, 0, 3000000.00, 1, 0.00, 3000000.00),
(17, 'administrator-PO-07-10-2020-10', 9, 0, 2000000.00, 1, 0.00, 2000000.00),
(18, 'administrator-PO-07-10-2020-10', 8, 0, 3000000.00, 1, 0.00, 3000000.00),
(19, 'administrator-PO-07-10-2020-11', 18, 0, 100000.00, 1, 0.00, 100000.00),
(20, 'administrator-PO-07-10-2020-12', 9, 0, 2000000.00, 5, 0.00, 10000000.00),
(21, 'administrator-PO-07-10-2020-13', 10, 0, 5000000.00, 7, 0.00, 35000000.00);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_dtlmutasi`
--

CREATE TABLE `tb_dtlmutasi` (
  `id_dtlmutasibarang` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_dtlreturjual`
--

INSERT INTO `tb_dtlreturjual` (`id_detailreturpenjualan`, `id_retur`, `id_detailpenjualan`, `id_barang`, `satuan`, `jumlahretur`, `harga`, `status`) VALUES
(1, 'administrator-RJ-07-10-2020-1', 1, 8, 0, 1, 3000000, 1),
(2, 'administrator-RJ-07-10-2020-2', 5, 19, 0, 2, 2000000, 1),
(3, 'administrator-RJ-14-10-2020-5', 1, 8, 0, 1, 3000000, 1),
(4, 'administrator-RJ-16-10-2020-6', 1, 8, 0, 2, 3000000, 1);
...
INSERT INTO `tb_gudang` (`id_gudang`, `gudang`, `id_cabang`, `alamat`, `tlf`, `email`, `id_kota`, `id_kecamatan`, `id_provinsi`, `id_user`, `tglupdate`) VALUES
(1, 'pusat', 1, 'brebes', '1232112', 'ad@ads', '3329', '3329170', '33', 1, '2020-08-20'),
(3, 'gudang a', 2, '', '', '', '3171', '3171050', '31', 1, '2020-08-22'),
(4, 'Gudang Surabaya', 2, 'qwert', '081330181664', 'hijriyah@mail.com', '3604', '3604210', '36', 1, '2020-08-23'),
(5, 'Gudang Surabaya Utara', 6, 'afnv', '081330181664', 'AS@gmail.com', '5106', '5106020', '51', 1, '2020-10-21'),
(6, 'gudang c', 4, 'test qweqw', '123123123', 'hijriyahque@yahoo.com', '3204', '3204140', '32', 1, '2020-10-21');
...
--
-- Struktur dari tabel `tb_hargagaram`
--
...
--
-- Dumping data untuk tabel `tb_hargagaram`
--
...
CREATE TABLE `tb_invoicejual` (
  `id_invoicejual` varchar(50) NOT NULL,
  `id_penjualan` varchar(50) NOT NULL,
  `id_user` int(11) NOT NULL,
  `tglinvoice` date NOT NULL,
  `id_voucher` int(11) NOT NULL,
  `diskon` double(10,2) NOT NULL,
  `biayakirim` double(10,2) NOT NULL,
  `subtotal` double(10,2) NOT NULL,
  `total` double(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tb_invoicejual`
--

INSERT INTO `tb_invoicejual` (`id_invoicejual`, `id_penjualan`, `id_user`, `tglinvoice`, `id_voucher`, `diskon`, `biayakirim`, `subtotal`, `total`) VALUES
('administrator-INV-07-10-2020-1', 'admin-PO-05-10-2020-1', 1, '2020-10-07', 16, 0.00, 0.00, 6000000.00, 6000000.00),
('administrator-INV-14-10-2020-2', 'admin-PO-05-10-2020-1', 1, '2020-10-07', 16, 20000.00, 0.00, 0.00, 5990000.00),
('administrator-INV-16-10-2020-3', 'administrator-PO-07-10-2020-11', 1, '2020-10-16', 16, 20000.00, 0.00, 100000.00, 90000.00);
...
(17, 'penjualan', 'username-PO-tanggal-no'),
(18, 'invoice', 'username-INV-tanggal-no'),
(19, 'suratjalan', 'username-SJJ-tanggal-no'),
(20, 'returpenjualan', 'username-RJ-tanggal-no'),
(21, 'mutasibarang', 'username-MB-tanggal-no');
...
--
-- Struktur dari tabel `tb_mutasibarang`
--

CREATE TABLE `tb_mutasibarang` (
  `id_mutasibarang` int(11) NOT NULL,
  `tglmutasi` date NOT NULL,
  `gudangmutasi` int(11) NOT NULL,
  `cabangmutasi` int(11) NOT NULL,
  `totalmutasi` int(11) NOT NULL,
  `statusmutasi` enum('proses','diterima') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(11, 'Mifta', 'administrator-PL-02092020-1', '11', '1112', '1112060', 'sumput', '098098098098', -3100000, '2020-09-02', 1),
(12, 'rani', 'administrator-PL-02092020-2', '51', '5106', '5106040', 'driyorejo', '081224334445', -7000000, '2020-09-02', 1),
(13, 'RIZKY FEBRIANTO', 'administrator-PL-03092020-3', '51', '5106', '5106040', 'driyorejo', '098098098098', -12000000, '2020-09-03', 1);
...
INSERT INTO `tb_penjualan` (`id_penjualan`, `id_pelanggan`, `id_sales`, `id_cabang`, `id_user`, `tglpojual`, `tgljatuhtempo`, `jenispembayaran`, `diskon`, `subtotal`, `status`) VALUES
('admin-PO-05-10-2020-1', 11, 1, 2, 8, '2020-10-05', '2020-10-05', 'cash', 0.00, 6000000.00, 1),
('admin-PO-07-10-2020-9', 11, 1, 2, 8, '2020-10-07', '2020-10-07', 'kredit', 0.00, 3000000.00, 1),
('administrator-PO-05-10-2020-2', 13, 1, 1, 1, '2020-10-05', '2020-10-05', 'cash', 0.00, 28000000.00, 1),
('administrator-PO-05-10-2020-3', 13, 1, 1, 1, '2020-10-05', '2020-10-05', 'cash', 0.00, 8000000.00, 1),
('administrator-PO-05-10-2020-4', 13, 1, 1, 1, '2020-10-05', '2020-10-05', 'cash', 0.00, 2200000.00, 1),
('administrator-PO-07-10-2020-10', 11, 1, 2, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 5000000.00, 1),
('administrator-PO-07-10-2020-11', 11, 1, 1, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 100000.00, 1),
('administrator-PO-07-10-2020-12', 11, 1, 2, 1, '2020-10-07', '2020-10-07', 'cash', 0.00, 10000000.00, 1),
('administrator-PO-07-10-2020-13', 11, 1, 1, 1, '2020-10-07', '2020-10-07', 'cash', 0.00, 35000000.00, 1),
('administrator-PO-07-10-2020-5', 12, 1, 1, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 8000000.00, 1),
('administrator-PO-07-10-2020-6', 12, 1, 1, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 2100000.00, 1),
('administrator-PO-07-10-2020-7', 12, 1, 2, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 5100000.00, 1),
('administrator-PO-07-10-2020-8', 13, 1, 2, 1, '2020-10-07', '2020-10-07', 'kredit', 0.00, 15000000.00, 1);
...
--
-- Dumping data untuk tabel `tb_returjual`
--

INSERT INTO `tb_returjual` (`id_returpenjualan`, `id_penjualan`, `tanggalretur`, `jenisretur`, `ketretur`, `total`, `status`) VALUES
('administrator-RJ-07-10-2020-1', 'admin-PO-05-10-2020-1', '2020-10-07', 'nota', 'rusak', 0.00, 1),
('administrator-RJ-07-10-2020-2', 'administrator-PO-05-10-2020-3', '2020-10-07', 'barang', 'parah', 0.00, 1),
('administrator-RJ-14-10-2020-3', 'administrator-PO-05-10-2020-3', '2020-10-14', 'nota', 'parah', 4000000.00, 1),
('administrator-RJ-14-10-2020-4', 'admin-PO-05-10-2020-1', '2020-10-14', 'nota', 'aaaaaaa', 3000000.00, 1),
('administrator-RJ-14-10-2020-5', 'admin-PO-05-10-2020-1', '2020-10-14', 'nota', 'aaaaavvvvvv', 3000000.00, 1),
('administrator-RJ-16-10-2020-6', 'admin-PO-05-10-2020-1', '2020-10-16', 'nota', 'rusak parah', 6000000.00, 1);
...
CREATE TABLE `tb_sjpenjualan` (
  `id_suratjalan` varchar(50) NOT NULL,
  `id_penjualan` varchar(50) NOT NULL,
  `id_user` int(11) NOT NULL,
  `tglkirim` date NOT NULL,
  `namapengirim` varchar(100) NOT NULL,
  `alamatkirim` varchar(100) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tb_sjpenjualan`
--

INSERT INTO `tb_sjpenjualan` (`id_suratjalan`, `id_penjualan`, `id_user`, `tglkirim`, `namapengirim`, `alamatkirim`, `status`) VALUES
('administrator-SJJ-07-10-2020-1', 'admin-PO-05-10-2020-1', 1, '2020-10-07', 'Hijriyah', 'Bambe, Gresik', 1),
('administrator-SJJ-14-10-2020-2', 'admin-PO-05-10-2020-1', 1, '2020-10-07', 'Mifta', 'Sumput', 0),
('administrator-SJJ-14-10-2020-3', 'administrator-PO-05-10-2020-3', 1, '2020-10-14', 'Hijriyah', 'driyo', 0),
('administrator-SJJ-16-10-2020-4', 'administrator-PO-07-10-2020-11', 1, '2020-10-16', 'Mirza', 'Bambe', 0),
('administrator-SJJ-16-10-2020-5', 'administrator-PO-07-10-2020-11', 1, '2020-10-16', 'fauzi', 'driyo', 0);
...
(1, 1, '1', 'administrator', 'baliasd', '5107040', '5107', '51', '12345678', 'administrator', 'admin', 'admin', 2, 1, '2020-08-22'),
...
(38, 2, 'Retur Penjualan', 'C_returpenjualan', 'aktif'),
(39, 1, 'Data Gudang', 'C_gudang', 'aktif'),
(40, 1, 'Data Barang Garam', 'C_baranggaram', 'tidak'),
(41, 1, 'Data Harga Garam', 'C_hargagaram', 'tidak');
...
(434, 1, '2020-10-21 01:54:11', 0, 'Login'),
(435, 1, '2020-10-21 10:14:24', 0, 'Login'),
(436, 1, '2020-10-21 13:26:54', 0, 'Login'),
(437, 1, '2020-10-21 17:42:05', 0, 'Login'),
(438, 1, '2020-10-21 18:46:05', 0, 'Login'),
(439, 1, '2020-10-21 07:42:00', 32, 'edit data cabang'),
(440, 1, '2020-10-21 19:51:52', 0, 'Login'),
(441, 1, '2020-10-21 08:03:37', 39, 'tambah data cabang'),
(442, 1, '2020-10-21 08:06:09', 39, 'tambah data cabang'),
(443, 1, '2020-10-21 08:07:59', 39, 'tambah data cabang'),
(444, 1, '2020-10-21 08:08:51', 39, 'tambah data cabang'),
(445, 1, '2020-10-21 08:13:23', 39, 'tambah data gudang'),
(446, 1, '2020-10-21 08:17:36', 39, 'edit data gudang'),
(447, 1, '2020-10-21 08:17:47', 39, 'edit data gudang'),
(448, 1, '2020-10-21 08:22:46', 5, 'tambah data satuan'),
(449, 1, '2020-10-21 20:37:18', 0, 'Logout'),
(450, 1, '2020-10-21 20:37:20', 0, 'Login'),
(451, 1, '2020-10-21 20:38:30', 0, 'Logout'),
(452, 1, '2020-10-21 20:39:28', 0, 'Login'),
(453, 1, '2020-10-23 22:41:17', 0, 'Login');
...
(17, 'administrator-VC-25092020-2', 'Mifta', 'dasfs', 2000000, '0000-00-00', '2020-09-30', 10000, 1, '2020-09-25');
...
--
-- Indeks untuk tabel `tb_baranggaram`
--
ALTER TABLE `tb_baranggaram`
  ADD PRIMARY KEY (`id_barang`);

--
-- Indeks untuk tabel `tb_bonussales`
--
ALTER TABLE `tb_bonussales`
  ADD PRIMARY KEY (`id_bonussales`);
...
--
-- Indeks untuk tabel `tb_hargagaram`
--
...
--
ALTER TABLE `tb_akses`
  MODIFY `id_akses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
-- AUTO_INCREMENT untuk tabel `tb_baranggaram`
--
ALTER TABLE `tb_baranggaram`
...
--
ALTER TABLE `tb_dtlreturjual`
  MODIFY `id_detailreturpenjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT untuk tabel `tb_hargagaram`
--
ALTER TABLE `tb_hargagaram`
...
--
ALTER TABLE `tb_kode`
  MODIFY `id_kode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=454;
