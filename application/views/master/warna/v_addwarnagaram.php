  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('C_warnagaram'); ?>">Data warna Barang</a></li>>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_warnagaram/tambah')?>">
              <div class="box-body">
      ...
      <div class="row">
         <form class="form-horizontal" method="POST" action="<?php echo site_url('C_warnagaram')?>">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <!--<a href="<?php echo site_url('C_warnagaram/add'); ?>"><button type="button" class="btn btn-warning" >Tambah Data</button></a>--> 
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
