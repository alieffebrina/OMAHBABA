            ...
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_warna')?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="warna" name="warna" value="<?php echo $warna->warna ?>" readonly>
                  </div>
                </div>
              </div>
              <?php } ?>
              ...
              <div class="box-footer">
                  <div class="col-sm-10">
                    <a href="<?php echo site_url('C_warna/add'); ?>" class="btn btn-default">Kembali</a>
                  </div>
              </div>
              <!-- /.box-footer -->
            </form>
